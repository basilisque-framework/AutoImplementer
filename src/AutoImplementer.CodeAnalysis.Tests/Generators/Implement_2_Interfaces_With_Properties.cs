...
public class Implement_2_Interfaces_With_Properties : BaseAutoImplementerGeneratorTest
{
    protected override void AddSourcesUnderTest(SourceFileList sources)
    {
        ...
        sources.Add(@"
namespace AutoImpl.TestObjects;
...
");
    ...
    {
        yield return (
            Name: "AutoImpl.TestObjects.Movie.auto_impl.g.cs",
...
#nullable restore");
    ...
    protected override IEnumerable<DiagnosticResult> GetExpectedDiagnostics()
    {
        ...
        yield return DiagnosticResult.CompilerWarning("CS8618")
            .WithSpan(@"Basilisque.AutoImplementer.CodeAnalysis\Basilisque.AutoImplementer.CodeAnalysis.AutoImplementerGenerator\AutoImpl.TestObjects.Movie.auto_impl.g.cs", 21, 23, 21, 28)
            .WithSpan(@"Basilisque.AutoImplementer.CodeAnalysis\Basilisque.AutoImplementer.CodeAnalysis.AutoImplementerGenerator\AutoImpl.TestObjects.Movie.auto_impl.g.cs", 21, 23, 21, 28);
    }
}
