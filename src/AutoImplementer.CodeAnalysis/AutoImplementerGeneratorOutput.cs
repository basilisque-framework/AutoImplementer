...
internal static class AutoImplementerGeneratorOutput
{
    ...
    private const string C_AUTO_IMPLEMENT_INTERFACE_ATTRIBUTE_COMPILATIONNAME = C_AUTO_IMPLEMENT_INTERFACE_ATTRIBUTE_CLASSNAME;
    private const string C_AUTOIMPLEMENTATTRIBUTE_ON_MEMBERS_COMPILATIONNAME = C_AUTO_IMPLEMENT_ON_MEMBERS_ATTRIBUTE_CLASSNAME;
